...
export async function toggleFollow(
  ...
  await updateFollowingOfLoggedInUser(activeUserDocId, profileUserId, isFollowingProfile)
  await updateFollowersOfFollowedUser(profileDocId, followingUserId, isFollowingProfile)
}